...
function getWakeboard($where, $date)
{
	...
	$res = $conn->prepare("SELECT sm.duration AS smDuration, st.duration AS stDuration, a.id, a.start, a.end, mem.last_name AS member_lastname, a.last_name AS customer_lastname, 

	...
	<nav>
		...
		<ul>
				...
				<ul>
						...
						<h2><?php echo $menu1->menu_name." > ";echo $menu2->submenu_name;?><br>
							<br>Subtask:
						</h2>
						<ul><?php
							...
							if ($res3->rowCount () > 0) {
								...
								<h2><?php echo $menu1->menu_name." > ";echo $menu2->submenu_name." > ";echo $menu3->subtask_name;?></h2>
	...
	<nav>
		...
		<ul>
			<li><a><i class="glyphicon glyphicon-chevron-right"></i>Windsurfing</a>
				...
				<ul>
					<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Lessons</a>
						...
						<ul>
							<li><h2>Introduction Hour</h2> <a href="#"><i
									class="glyphicon glyphicon-chevron-right"></i>Introduction Hour</a>
										<?php include("price.php"); ?>
                                    </li>
							<li><h2>Start Windsurfing - 5 Hours Course</h2> <a href="#"><i
									class="glyphicon glyphicon-chevron-right"></i>Start Windsurfing
									- 5 Hours Course</a>
										<?php include("price.php"); ?>
                                    </li>
							<li><h2>Windsurfing Intermediate - 3 Hours Course</h2> <a
			...
			<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Stand
				...
				<ul>
					...
					<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Rent</a>
						<h2>Rent</h2>
						<ul>
							<li><h2>1 Hour</h2> <a href="#"><i
									class="glyphicon glyphicon-chevron-right"></i>1 Hour</a>
										<?php include("price.php"); ?>
                                    </li>
							<li><h2>30 Hours</h2> <a href="#"><i
									class="glyphicon glyphicon-chevron-right"></i>30 Hours</a>
										<?php include("price.php"); ?>
                                    </li>
							<li><h2>Unlimited Use</h2> <a href="#"><i
			...
			<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Sailing</a>
				...
				<ul>
					<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Lessons</a>
						...
						<ul>
							<li><h2>Introduction Lesson - 1 Hour</h2> <a href="#"><i
									class="glyphicon glyphicon-chevron-right"></i>Introduction
									Lesson - 1 Hour</a>
										<?php include("price.php"); ?>
                                    </li>
							<li><h2>Learn Sailing - 3 Hours + 1 Hour Free</h2> <a href="#"><i
					...
					<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Rent</a>
						...
						<ul>
							...
							<li><h2>3 Hours</h2> <a href="#"><i
									class="glyphicon glyphicon-chevron-right"></i>3 Hours</a>
										<?php include("price.php"); ?>
                                    </li>
							<li><h2>5 Hour</h2> <a href="#"><i
									class="glyphicon glyphicon-chevron-right"></i>5 Hour</a>
										<?php include("price.php"); ?>
                                    </li>
							<li><h2>HobleCat ride with instructor, up to 2 persons, 30
									minutes</h2> <a href="#"><i
			...
			<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Kitesurfing</a>
				<h2>Kitesurfing</h2>
				<ul>
					<li><h2>Stages 1,2 or 3 - 3 Hours Course</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>Stages 1,2 or 3 - 3
							Hours Course</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>Stage 1 and 2 - 6 Hours Course</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>Stage 1 and 2 - 6
							Hours Course</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>Stage 1,2 and 3 - 9 Hours Course</h2> <a href="#"><i
			...
			<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Jet-ski</a>
				...
				<ul>
					<li><h2>1 Person 15 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>1 Person 15 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>2 Persons 15 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>2 Persons 15
							minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>1 Person 15 minutes with Fast Key</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>1 Person 15 minutes
							with Fast Key</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>2 Persons 15 minutes with Fast Key</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>2 Persons 15
							minutes with Fast Key</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>1 Person 15 minutes (Yamaha FX)</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>1 Person 15 minutes
							(Yamaha FX)</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>2 Persons 15 minutes (Yamaha FX)</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>2 Persons 15
							minutes (Yamaha FX)</a>
								<?php include("price.php"); ?>
                            </li>
			...
			<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Boat
				...
				<h2>Boat Rental</h2>
				<ul>
					<li><h2>40 Horse Power - 30 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>40 Horse Power - 30
							minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>40 Horse Power - 60 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>40 Horse Power - 60
							minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>150 Horse Power - 30 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>150 Horse Power -
							30 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>150 Horse Power - 60 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>150 Horse Power -
							60 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>200 Horse Power - 30 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>200 Horse Power -
							30 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>200 Horse Power - 60 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>200 Horse Power -
							60 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>Half-day rental - 40hp, 3 Hours</h2> <a href="#"><i
			...
			<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Inflatables</a>
				<h2>Inflatables</h2>
				<ul>
					<li><h2>Banana, minimum 3 persons, 10 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>Banana, minimum 3
							persons, 10 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>Sofas 2,3 or 4 persons, 10 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>Sofas 2,3 or 4
							persons, 10 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>Fly Fish 2 or 3 persons, 10 minutes</h2> <a href="#"><i
			...
			<li><a href="#"><i class="glyphicon glyphicon-chevron-right"></i>Pedal
				...
				<h2>Pedal Boats</h2>
				<ul>
					<li><h2>Pedal boat without slide, 30 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>Pedal boat without
							slide, 30 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>Pedal boat without slide, 60 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>Pedal boat without
							slide, 60 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>Pedal boat with slide, 30 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>Pedal boat with
							slide, 30 minutes</a>
								<?php include("price.php"); ?>
                            </li>
					<li><h2>Pedal boat with slide, 60 minutes</h2> <a href="#"><i
							class="glyphicon glyphicon-chevron-right"></i>Pedal boat with
							slide, 60 minutes</a>
								<?php include("price.php"); ?>
                            </li>

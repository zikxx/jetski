...
try {
	 ...
	 * * INSERT data **
	 */
	$stmt = $dbh->prepare("INSERT INTO activities(name, submenu, subtask, price, payment, start, paid_price, driver, 
first_name, last_name, paid, type, status)
	VALUES (:name, :submenu, :subtask, :price, :payment, :start, :paid_price, :driver, :first_name, :last_name, :paid, :type, 'Active')");
